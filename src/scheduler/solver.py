...
class ScheduleSolver:
    ...
    def solve_with_date_range(
        ...
        existing_schedule: list[ScheduledShift] | None = None,
    ...
    def debug_solver_state(
        ...
        Add this to your ScheduleSolver class
        """
        ...
        for i, req in enumerate(requirements):
            ...
            print(f"     Day: {req.time_slot.day_of_week} ({['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'][req.time_slot.day_of_week]})")
