...
from ..graph.tigergraph_client import SemanticPropertyExpander, TigerGraphClient
...
from ..models.results import MatchExplanation, MatchReason
...
class ExplainableCompositeScorer:
    ...
    def __init__(
        ...
        tigergraph_client: TigerGraphClient | None = None
    ):
        self.weights = {
    ...
    async def _score_preferences_with_explanation(
        ...
        for pref in preferences:
            ...
            if pref.strength == PreferenceStrength.EXCLUDE:
                continue
