...
from ..models.results import MatchExplanation, MatchOffer, MatchReason, MatchResult
from .graph import FeatureMatchResult, GraphClient, get_graph_client
...
class MatchRequest(BaseModel):
    ...
    required_hours: dict[str, Any] | None = None  # Time slot requirements
...
class Matcher:
    ...
    def __init__(self, db_manager: DatabaseManager, graph_client: GraphClient | None = None):
        """
        Initialize  matcher.
